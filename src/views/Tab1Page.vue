...
<script lang="ts">
import { IonPage, IonContent, IonRow, IonCol, IonText, IonImg, IonCard, IonCardSubtitle, IonSpinner, IonRefresher, IonRefresherContent } from '@ionic/vue';
  ...
  methods: {
    async getLocation() {
      try {
        ...
        this.getWeatherDataDay(latitude, longitude);
      } catch (error) {
        console.error(error);
      }
    },
